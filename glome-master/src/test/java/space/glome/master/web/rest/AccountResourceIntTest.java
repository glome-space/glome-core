package space.glome.master.web.rest;

import space.glome.master.GlomeApp;
import space.glome.master.domain.Authority;
import space.glome.master.domain.User;
import space.glome.master.repository.AuthorityRepository;
import space.glome.master.repository.UserRepository;
import space.glome.master.security.AuthoritiesConstants;
import space.glome.master.service.MailService;
import space.glome.master.service.UserService;
import space.glome.master.service.dto.UserDTO;
import space.glome.master.web.rest.AccountResource;
import space.glome.master.web.rest.vm.KeyAndPasswordVM;
import space.glome.master.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = GlomeApp.class)
